...
var rect1,rect2,rect3,rectBody;
...
function setup() {
	...
	rect1=createSprite(310,610,20,100);
	...
	rectBody = Bodies.rectangle(400,635,200,20,{isStatic:true});
...
function keyPressed() {
 if (keyCode === DOWN_ARROW) {
	...
	Matter.Body.setStatic(rectBody,true);
